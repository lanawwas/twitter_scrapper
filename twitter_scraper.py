...
rule = gen_request_parameters(query=query, tweet_fields=["created_at", "public_metrics", "author_id", "lang", "conversation_id", 
                                                         "in_reply_to_user_id", "referenced_tweets"], expansions=["author_id"], user_fields=["username", "public_metrics", "verified"], place_fields=["full_name", "country_code"], media_fields=["duration_ms", "height", "media_key", "public_metrics", "type", "width", "url"])
